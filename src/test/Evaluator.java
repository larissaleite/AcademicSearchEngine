...
public class Evaluator {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < WeightedSimilarityTypes.values().length; i++) {
			...
			m.put(s,f.evaluate("C:\\Users\\Moditha\\Desktop\\user-doc-weighted.csv", i));
			
		}
		//EvaluatorFactory f = new EvaluatorFactory();
		
		//m.put("AA", f.evaluate("C:\\Users\\Moditha\\Desktop\\user-doc-weighted.csv", 3));
		...
		for (String string : m.keySet()) {
			...
			try {
				Writer writer = new BufferedWriter(
						new OutputStreamWriter(new FileOutputStream("D:\\"+string+".csv"), "utf-8"));
